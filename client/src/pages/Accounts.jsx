...
const Accounts = () => {
  ...
  const fetchAccounts = async (isSync = false, platform, successMessage) => {
    ...
    <div className="space-y-8 max-w-4xl">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 text-sm">
        <div>
          ...
          <p className="text-slate-500 text-sm !mt-0.5">{accounts.length} of {PLATFORMS.length}</p>
        </div>
