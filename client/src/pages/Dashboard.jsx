...
const Dashboard = () => {
  ...
  const statCards = [
    ...
    { label: "Published Posts", value: stats.published, icon: CircleCheckIcon, trend: "All time" },
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
        {
          statCards.map((card, idx) => {
            return (
              <div key={idx} className="bg-white hover:bg-red-50 relative border border-slate-200 rounded-2xl !p-5 hover:border-red-200 transition-all">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden">
        <div className="flex items-center justify-between !px-6 !py-4 border-b border-slate-100 overflow-y-scroll">
